...
import SceneSelectorItemComponent from '../components/scene-selector-item/scene-selector-item.jsx';

class SceneSelectorItem extends React.PureComponent {
    constructor (props) {
        super(props);
        bindAll(this, [
            'getCostumeData',
