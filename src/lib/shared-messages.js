...
export default defineMessages({
    ...
    scene: {
        defaultMessage: 'scene{index}',
        description: 'Default name for a new scene, scratch will automatically adjust the number if necessary',
        id: 'gui.sharedMessages.scene'
    },
    sprite: {
