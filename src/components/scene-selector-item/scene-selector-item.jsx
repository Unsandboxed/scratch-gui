...
import styles from './scene-selector-item.css';
...
const SceneSelectorItem = props => (
    <ContextMenuTrigger
        attributes={{
            className: classNames(props.className, styles.sceneSelectorItem, {
    ...
    >
        ...
        {props.costumeURL ? (
            <div className={styles.sceneImageOuter}>
                <div className={styles.sceneImageInner}>
                    <img
        ...
        <div className={styles.sceneInfo}>
            <div className={styles.sceneName}>{props.name}</div>
            {props.details ? (
                <div className={styles.sceneDetails}>{props.details}</div>
            ) : null}
        </div>
